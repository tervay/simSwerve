...
class MotorGearboxWheelSim {
     ...
     *                                      down motors (ie all of them) should have
     ...
     *                                      in the gearbox (expressed in units of Nm
     *                                      of "fighting" force per
     *                                      radian per second of motor speed). Set
     *                                      to 0 if you're awesome
     *                                      with white lithium grease, make it
     *                                      positive if your team maybe
